      ...
      <div className="relative z-10 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl font-cinzel font-bold mb-4" style={{ color: "#f0e6c8" }}>Puzzle Challenge</h1>
            ...
            >
              ...
              <p className="font-rajdhani" style={{ color: "rgba(226,232,240,0.45)" }}>
                Challenge friends to puzzle-solving competitions, track scores, and compete in real-time puzzle battles.
              </p>
            </div>
          </div>
        </div>
